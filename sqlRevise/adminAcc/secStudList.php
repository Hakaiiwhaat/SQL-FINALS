...
<div class="transBg"></div>
    ...
    <div class="welcome text-center mt-5">
        <p class="welc display-1">Student's List</p>
    </div>
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
        ...
        <ul class="list-group list-group-flush mt-3">
            ...
            <li class="list-group-item  mt-4"><a href="" style="color: red">Log out</a></li>
        </ul>
        </div>
    </div>
    ...
    $sqlSectionID = "SELECT FROM sectionsession WHERE adminID = '$adminID' AND sectionID = '$sectionID'";
